  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Trace the journey of Proto-Indo-European, from the Pontic-Caspian steppe
          to Sanskrit, Greek, Latin, and English, through genetics, archaeology,
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: showStats ? 0 : 0.5 }}
